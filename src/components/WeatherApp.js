    ...
    <React.Fragment>
      ...
      >
        <Box sx={{ ...modalStyle, width: 200 }}>
                  ...
                  <ul>
                      <Link href="https://github.com/hlbrown/WeatherApp" target="_blank"><li>Github Repo: </li></Link>
                      <Link href="https://github.com/hlbrown/WeatherApp" target="_blank"><li>Live URL</li></Link>
                  </ul>
          ...
          >
            <Box
              sx={{
                ...
                backgroundImage: `url(https://i.ibb.co/FzdLXGS/weather-App.jpg)`,
              }}
            />
            ...
            >
              ...
              ><Button color="inherit" onClick={handleOpen}>Weather App</Button>
                <Modal
                open={open}
                  onClose={handleClose}
                ...
                <h2 id="parent-modal-title">Weather App</h2>
                <p id="parent-modal-description">
                This app is designed to show you the five day forecast depending on the location you search.
                    </p>
                    <ul>
                      <li>OpenWeather One Call Api</li>
                      <li>Uses Local Storage</li>
                      <li>Styled with Bootstrap CSS</li>
                      <li>JavaScript</li>
                    </ul>
          <ChildModal />
        </Box>
